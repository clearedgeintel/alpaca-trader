...
app.get('/api/config', (req, res) => {
  ...
  res.json({
    ...
    data: {
      ...
      // Momentum-pool bypass of the orchestrator confidence floor. Default on.
      momentumBypassConfidenceFloor: effective.MOMENTUM_BYPASS_CONFIDENCE_FLOOR !== false,
      ...
      momentumMinVolume: effective.MOMENTUM_MIN_VOLUME ?? config.MOMENTUM_MIN_VOLUME,
      momentumRiskPct: effective.MOMENTUM_RISK_PCT ?? config.MOMENTUM_RISK_PCT,
      momentumStopPct: effective.MOMENTUM_STOP_PCT ?? config.MOMENTUM_STOP_PCT,
      momentumTargetPct: effective.MOMENTUM_TARGET_PCT ?? config.MOMENTUM_TARGET_PCT,
      momentumTimeExitMin: effective.MOMENTUM_TIME_EXIT_MIN ?? config.MOMENTUM_TIME_EXIT_MIN,
      momentumMinGainAtExit: effective.MOMENTUM_MIN_GAIN_AT_EXIT ?? config.MOMENTUM_MIN_GAIN_AT_EXIT,
      momentumMaxOpen: effective.MOMENTUM_MAX_OPEN ?? config.MOMENTUM_MAX_OPEN,
      momentumConfidence: effective.MOMENTUM_CONFIDENCE ?? config.MOMENTUM_CONFIDENCE,
