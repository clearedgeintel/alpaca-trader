...
| **Prompt A/B testing framework** | Version-tagged decisions (migration 006), per-version performance endpoint joining to trades, AgentsView panel with Activate button. Shadow-mode parallel runs deferred. | Systematic prompt improvement | Medium | ✅ Done (Apr 15, lightweight tagging MVP) |
